        ...
        return (
            <div className='whitePage page3 quad'>
                ...
                <div className='column'>
                    ...
                    <div className='row'>
                        <h1>Usage</h1>
                        <h3>CodeXR can be installed as an extension for the popular code editor, vscode, and to request a completion, a keybind is used.</h3>
                    </div>
                </div>
            </div>
        );
